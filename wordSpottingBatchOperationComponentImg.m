function [distVal,jumpcost] = wordSpottingBatchOperationComponentImg(featureMatForImage,realIndexMatForImage,l1,l4,...
                                topTest,baseTest,testImgRw,testImgCol,allRefImgInfo,featureFunc,matchingFunc,technique,...
                                            avgWidth,avgHeight,heightMatter,testImgPath,imageFiePath_1,testName)
for eachRefPath = 1:1:size(allRefImgInfo,1)
    ...
    if(strcmp(matchingFunc,'Old_Normalize'))
        [distVal,jumpcost] = performMatchingOnComponentImg_Old(featureMatForImage,realIndexMatForImage,...
            componentRefImg,ImgRef,testImgRw,testImgCol,technique,featureFunc,avgWidth,heightMatter,testImgPath,imageFiePath_1,testName);
