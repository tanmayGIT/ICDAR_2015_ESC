%This code is same as MVM_Updated_17_6, but here we tried different
%normalization technique.
% normalization tecnique :
% dist+jumpCost*(number of skips at the beggining and at the end of
% target)/ size of matched parts of target + number of skips at the
% beginning and at the end
function [pathCost,pathTarget,indxcol,indxrow,distSum,jumpcost] = MVM_Updated_17_6_normTech_4(refSample,testSample,weight,bal)
