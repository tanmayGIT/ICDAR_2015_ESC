...
function [pathCost,pathTarget,indxcol,indxrow,distSum,jumpcost] = MVM_Updated_17_6_Reverse_1(refSample,testSample,weight,bal)
...
%                         jumpedQueryEle = jumpedQueryEle + ((abs(prevRw - minrow))-1);
%                     end
%                     if(prevCol ~= mincol)% the many to one does not work
...
%                 end
        ...
        endSkip = abs(noOfSamplesInTestSample - indxcol(end,1));
        begSkip = (indxcol(1,1) -1);
