function [pathCost,distVal,getIntoCell,jumpcost] = stringMatchingWithFunction(refWordMat,testWordMat,realIndexRef,realIndexTest,technique,featureFunc,avgWdth) % refCharWord is
...
if(strcmp(technique,'DTW'))
    ...
    if((size(refWordMat,1)) < (size(testWordMat,1)))
        ...
        elseif(strcmp(technique,'WDTW'))
            [distVal,indexCol,indexRow] = WDTW(refWordMat,testWordMat);
            pathCost = 0;
        ...
        elseif(strcmp(technique,'SC_Band'))
            [distVal,indexCol,indexRow] = DynamicTimeWarping_SC_Band(refWordMat,testWordMat);
            pathCost = 0;
        ...
        elseif(strcmp(technique,'WDDTW'))
            [distVal,indexCol,indexRow] = Weighted_Derivative_DynamicTimeWarping(refWordMat,testWordMat);
            pathCost = 0;
        ...
        elseif(strcmp(technique,'OSB'))
            ...
            [pathCost,indexCol,indexRow,distVal] = OSBv5(refWordMat,testWordMat,warpwin,queryskip,targetskip);
        ...
        elseif(strcmp(technique,'MVM_Updated_12'))
            [pathCost,~,indexCol,indexRow,distVal,jumpcost] = MVM_Updated_12_3(refWordMat,testWordMat,doBin,straight);
        ...
        elseif(strcmp(technique,'MVM_Updated_15'))
            [pathCost,indexCol,indexRow,distVal] = MVM_Updated_15(refWordMat,testWordMat,1);
        elseif(strcmp(technique,'MVM_Updated_16'))
            [pathCost,~,indexCol,indexRow,distVal,jumpcost] = MVM_Updated_16(refWordMat,testWordMat,doBin,straight);
        ...
        elseif(strcmp(technique,'MVM_Updated_19'))
            [pathCost,~,indexCol,indexRow,distVal,jumpcost] = MVM_Updated_19(refWordMat,testWordMat,doBin,straight);
        end
        ...
        elseif(strcmp(technique,'WDTW'))
            [distVal,indexCol,indexRow] = WDTW(testWordMat,refWordMat);
            pathCost = 0;
        elseif(strcmp(technique,'JawaharDTW'))
        ...
        elseif(strcmp(technique,'Itekura_Band'))
            ...
            pathCost = 0;
        elseif(strcmp(technique,'SC_Band'))
            [distVal,indexCol,indexRow] = DynamicTimeWarping_SC_Band(testWordMat,refWordMat);
            pathCost = 0;
        elseif(strcmp(technique,'DTW_CW'))
        ...
        elseif(strcmp(technique,'PDDTW'))
            ...
            pathCost = 0;
        elseif(strcmp(technique,'WDDTW'))
            [distVal,indexCol,indexRow] = Weighted_Derivative_DynamicTimeWarping(testWordMat,refWordMat);
            pathCost = 0;
        elseif(strcmp(technique,'DDTW'))
        ...
        elseif(strcmp(technique,'OSB'))
            ...
            [pathCost,indexCol,indexRow,distVal] = OSBv5(testWordMat,refWordMat,warpwin,queryskip,targetskip);
        elseif(strcmp(technique,'MVM_Updated'))
        ...
        elseif(strcmp(technique,'MVM_Updated_12'))
            [pathCost,~,indexCol,indexRow,distVal,jumpcost] = MVM_Updated_12_Reverse_2(testWordMat,refWordMat,doBin);
        elseif(strcmp(technique,'MVM_Updated_13'))
            [pathCost,~,indexCol,indexRow,distVal,jumpcost] = MVM_Updated_11(testWordMat,refWordMat,doBin);
        elseif(strcmp(technique,'MVM_Updated_14'))
            [pathCost,~,indexCol,indexRow,distVal,jumpcost] = MVM_Updated_11(testWordMat,refWordMat,doBin);
        ...
        elseif(strcmp(technique,'MVM_Updated_19'))
            [pathCost,~,indexCol,indexRow,distVal,jumpcost] = MVM_Updated_19(testWordMat,refWordMat,doBin);
        end
        if(strcmp(featureFunc,'columnFeature'))
...
%             if((strcmp(technique,'MVM_Updated_17'))|| (strcmp(technique,'MVM_Updated_9'))|| (strcmp(technique,'MVM_Updated_12')))
