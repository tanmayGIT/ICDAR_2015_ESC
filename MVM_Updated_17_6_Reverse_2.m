...
function [pathCost,pathTarget,indxcol,indxrow,distSum,jumpcost] = MVM_Updated_17_6_Reverse_2(refSample,testSample,weight,bal)
...
%         jumpedTargetEle = 0;
        ...
        distSum = distSum/(indxcol(1,end) -indxcol(1,1))+(begSkip + endSkip);
