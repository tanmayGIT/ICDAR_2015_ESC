...
% normalizing by the matched parts of targets
function [pathCost,pathTarget,indxcol,indxrow,distSum,jumpcost] = MVM_Updated_17_6_normTech_2(refSample,testSample,weight,bal)
